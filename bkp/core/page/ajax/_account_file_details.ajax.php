...
<div class="accountFileDetailsPopup">
            ...
            <div class="actions button-container">
                <div class="button-group minor-group">
					...
					<?php if(coreFunctions::getUsersAccountLockStatus($Auth->id) == 0): ?>
                        <a class="button icon edit" href="<?php echo WEB_ROOT; ?>/account_edit_item.<?php echo SITE_CONFIG_PAGE_EXTENSION; ?>?u=<?php echo (int) $file->id; ?>"><?php echo UCWords(t('account_file_details_edit_file', 'Editar Arquivo')); ?></a>
					...
					<?php endif; ?>
                        <a class="button icon arrowdown reponsiveMobileHide" href="<?php echo validation::safeOutputToScreen($file->getFullShortUrl()); ?>"><?php echo UCWords(t('account_file_details_download', 'Baixar')); ?></a>
                    <?php endif; ?>
                    <a class="button icon clock" href="<?php echo validation::safeOutputToScreen($file->getStatisticsUrl()); ?>"><?php echo UCWords(t('account_file_details_stats', 'Status')); ?></a>
                </div>
            </div>
        </div>
                    ...
                    <td>
                        <table class="accountStateTable">
                            <tbody>
                                <tr>
                                    <td class="first">
                                        <?php echo UCWords(t('filename', 'nome do arquivo')); ?>:
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="first">
                                        <?php echo UCWords(t('added', 'adicionado')); ?>:
                                    </td>
                                    <td>
                        ...
                        <table class="accountStateTable accountStateTableLightBox">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <strong><?php echo validation::safeOutputToScreen($file->visits); ?></strong>&nbsp;&nbsp;<?php echo ($file->lastAccessed != null) ? ('(' . UCWords(t('last_accessed', 'último acesso')) . ': ' . coreFunctions::formatDate($file->lastAccessed) . ')') : ''; ?>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        <div>
            <table class="accountStateTable reponsiveMobileHide">
                <tbody>
                    <tr>
                        <td class="first">
                            <?php echo t('html_code', 'Código HTML'); ?>:
                        </td>
                        <td class="htmlCode">
                    ...
                    <tr>
                        <td class="first">
                            <?php echo UCWords(t('forum_code', 'código do fórum')); ?>
                        </td>
                        <td class="htmlCode">
    ...
    <div id="pageHeader" class="reponsiveMobileHide" style="padding-top: 12px;">
        <h2><?php echo UCWords(t("options", "opções")); ?></h2>
    </div>
    <div>
        <table class="accountStateTable reponsiveMobileHide">
            <tbody>
                <tr>
                    <td class="first">
                        <?php echo UCWords(t('statistics_url', 'statísticas url')); ?>:
                    </td>
                    <td>
                ...
                <?php if ($file->statusId == 1): ?>
                    <tr>
                        <td class="first">
                            <?php echo UCWords(t('public_info_page', 'página de informação pública')); ?>:
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="first">
                            <?php echo UCWords(t('delete_file_url', 'Excluir URL do arquivo')); ?>:
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="first">
                            <?php echo UCWords(t('share_file', 'compartilhar arquivo')); ?>:
                        </td>
