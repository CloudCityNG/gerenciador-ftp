...
<div class="row clearfix">
    ...
    <div class="widget clearfix">
        ...
        <div class="widget_inside responsiveTable">
            <p>Below is the background (cron) tasks set to run on the system. Use this page to ensure they're running and see the last run time. For more information on setting up the crons, <a href="https://linkedin.com/in/jonathan-estefani" target="_blank">see here</a>.</p>
            ...
            <div class="adminResponsiveHide">
                <a href="https://linkedin.com/in/jonathan-estefani" class="button blue" target="_blank">More Information On Background Tasks/Crons</a>
            </div>
            <div class="clear"></div>
