...
$result['html'] .= '
                            ...
                            - <a href="https://linkedin.com/in/jonathan-estefani" target="_blank" style="text-decoration: underline;">XSendFile for Apache Information</a>.<br/><br/>
                            - <a href="https://linkedin.com/in/jonathan-estefani" target="_blank" style="text-decoration: underline;">X-Accel-Redirect for Nginx Information</a>.</span>
                        </div>
                    </div>';
$result['html'] .= '</span>';
