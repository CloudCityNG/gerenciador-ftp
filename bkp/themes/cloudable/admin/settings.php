...
define('ADMIN_PAGE_TITLE', $themes['theme_name'] . ' Configurações');
...
if (isset($_REQUEST['se'])) {
    ...
    adminFunctions::setSuccess('Configurações do Tema atualizado.');
}
    ...
    if (adminFunctions::isErrors() == false) {
        if (strlen($_FILES["site_logo"]["tmp_name"])) {
            ...
            if (exif_imagetype($_FILES["site_logo"]["tmp_name"]) != IMAGETYPE_PNG) {
                adminFunctions::setError('O logotipo não parece ser uma imagem PNG. Por favor verifique e tente novamente.');
            } elseif ($_FILES["site_logo"]["size"] > 200000) {
                adminFunctions::setError('O logotipo é maior que 200k de tamanho, reduza e tente novamente.');
            }
        }
                ...
                <form method="POST" action="settings.php" name="pluginForm" id="pluginForm" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="clearfix col_12">
                        <div class="col_4">
                            ...
                            <p>Logotipo do sistema, pele e outras configurações.</p>
                        </div>
                        <div class="col_8 last">
                            <div class="form">
                                <div class="clearfix alt-highlight">
                                    <label>Logotipo do sistema principal:</label>
                                    <div class="input">
                                        <input type="file" name="site_logo"/>
                                        <br/>
                                        <div class="formFieldFix" style='width: 500px; color: #777; font-size: 11px;'><br/>Mostrado na tela de login & amp; gerenciador de arquivos, geralmente em um fundo escuro. Deixe em branco para continuar a existir. Deve ser um png transparente. Baixe o <a href="../images/logo/logo.png" target="_blank" download>png original aqui</a>.</div>
                                        <br/>
                                        <br/>
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="input">
                                        ...
                                        <br/>
                                        <div class="formFieldFix" style='width: 500px; color: #777; font-size: 11px;'><br/>Mostrado nas páginas da pasta compartilhada, em um fundo branco. Deixe em branco para continuar a existir. Deve ser um png transparente. Baixe o <a href="../images/logo/logo-whitebg.png" target="_blank" download>png original aqui</a>.</div>
                                        <br/>
                                        <br/>
                                ...
                                <div class="clearfix">
                                    <label>Código CSS customizado:</label>
                                    <div class="input">
                                        ...
                                        <br/>
                                        <div class="formFieldFix" style='width: 500px; color: #777; font-size: 11px;'>Opcional. Use este campo para substituir qualquer um dos CSS do site sem ter que criar um novo tema. Ao clicar com o botão direito do mouse em um elemento no seu navegador e selecionar 'inspecionar', você pode encontrar as regras CSS relacionadas. Essas alterações serão mantidas após qualquer atualização de script.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="clearfix col_12">
                        <div class="col_4">
                            <h3>Previews de arquivos</h3>
                            <p>Configurações de controle em torno das pré-visualizações de arquivos, seja para mostrar documentos inline e mais.</p>
                        </div>
                        <div class="col_8 last">
                            <div class="form">
                                <div class="clearfix alt-highlight">
                                    ...
                                    <div class="input" style="margin-top: 5px; margin-bottom: 5px;">
                                        <a href="<?php echo WEB_ROOT; ?>/plugins/filepreviewer/admin/settings.php?id=58" class="button blue">Configurações de Pré-visualização de Arquivo</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="clearfix col_12">
                        <div class="col_4">
                            <h3>Login da Rede Social</h3>
                            <p>Quer habilitar o login no Facebook, no Twitter e nos detalhes da sua API.</p>
                        </div>
                        <div class="col_8 last">
                            <div class="form">
                                <div class="clearfix alt-highlight">
                                    <label>Access:</label>
                                    <div class="input" style="margin-top: 5px; margin-bottom: 5px;">
                                        <a href="<?php echo WEB_ROOT; ?>/plugins/sociallogin/admin/settings.php?id=28" class="button blue">Configurações de login da Rede Social</a>
                                    </div>
                                </div>
                            </div>
                        </div>
