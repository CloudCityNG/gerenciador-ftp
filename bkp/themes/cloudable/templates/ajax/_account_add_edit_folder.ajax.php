...
<form action="<?php echo WEB_ROOT; ?>/ajax/_account_add_edit_folder.process.ajax.php" autocomplete="off">
        ...
        <div class="row">
			...
			<div class="col-md-9">				
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label for="parentId" class="control-label"><?php echo t('edit_folder_parent_folder', 'Pastas para pais:'); ?></label>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<select class="form-control" name="isPublic" id="isPublic">
								...
								<option value="1" <?php echo ($isPublic == 1) ? 'SELECTED' : ''; ?>><?php echo t('privacy_public_limited_access', 'Público - Acesse se os usuários conheçam a URL da pasta.'); ?></option>
								<?php endif; ?>
								<option value="0" <?php echo ($isPublic == 0) ? 'SELECTED' : ''; ?>><?php echo t('privacy_private_no_access', 'Privado - Não há acesso fora de sua conta, a menos que você gere uma URL de acesso exclusiva.'); ?></option>
							</select>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label for="accessPassword" class="control-label"><?php echo t("edit_folder_optional_password", "Senha opcional:"); ?></label>
							<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							<p>
							<?php
							 echo t('edit_folder_privacy_notice_note', 'Nota: você não pode atualizar as configurações de privacidade desta pasta, pois as configurações da sua conta estão configuradas para tornar todos os arquivos privados ou a pasta principal é definida como privada.');
							?>
							</p>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							<label for="watermarkPreviews" class="control-label"><?php echo t('edit_folder_watermark_image_previews', 'Pré-visualizações de imagens de marca d\'água:'); ?> *</label>            
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="showDownloadLinks" class="control-label"><?php echo t('edit_folder_allow_download_links', 'Permitir o download quando compartilhado:'); ?></label>            
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<p style="color: #aaa;">
							<?php
							 echo t('edit_folder_watermark_notice_extra', '* Você pode configurar ou atualizar sua marca d\'água através da sua <a href="[[[WEB_ROOT]]]/account_edit.html">configuração de conta</a> na página. As imagens originais não serão marcadas com água.', array('WEB_ROOT'=>WEB_ROOT));
							?>
							</p>
						</div>
					</div>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-info" onClick="processAjaxForm(this, function(data) { <?php if($editFolderId == null): ?>setUploaderFolderList(data['folder_listing_html']);loadImages(data['folder_id']);<?php endif; ?> refreshFolderListing(false);$('.modal').modal('hide'); updateStatsViaAjax(); }); return false;"><?php echo $editFolderId==null?t("add_folder", "add folder"):t("update_folder", "pasta de atualização"); ?> <i class="entypo-check"></i></button>
    </div>
</form>