...
if (!$user)
{
    $rs['error'] = t("general_error", "Erro geral");
    echo json_encode($rs);
    exit;
}
...
{
    // log failure
    $rs['error'] = t("please_enter_your_password", "Digite sua nova senha");
}
elseif ($password != $confirmPassword)
{
    $rs['error'] = t("password_confirmation_does_not_match", "A confirmação da senha não corresponde");
}
