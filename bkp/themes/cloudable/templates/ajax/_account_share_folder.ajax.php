				...
				*/
				...
				<div role="tabpanel" class="tab-pane active" id="publicshare">
					<div class="row">
						<div class="col-md-12" style="margin-bottom: 20px;">
							...
							<?php
								if($isPublic == true)
								{
									echo "Como esta é uma pasta pública <strong> </ strong>, você pode compartilhar a URL da pasta abaixo para acesso direto aos arquivos, sem estar logado. Qualquer subpastas que esteja definida como Público também estará disponível.";
								}
								else
								{
									echo "Como esta é uma <strong> pasta particular </ strong>, você precisará gerar uma URL de compartilhamento para permitir o acesso aos arquivos. Clique no ícone abaixo para criar uma URL segura que você pode compartilhar sem configurar a pasta como acessível ao público.";
								}
							?>
							</p>
						</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label for="folderName" class="control-label"><?php echo t('edit_folder_sharing_url', 'Url de compartilhamento:'); ?></label>
								<div class="input-group">
									...
									<span class="input-group-btn" style="vertical-align: top;">
										<button id="copyToClipboardBtn" type="button" class="btn btn-primary" data-clipboard-action="copy" data-clipboard-target="#folderUrlSection" style="padding: 7px 12px;" data-placement="bottom" data-toggle="tooltip" data-original-title="Copiar URL para a área de transferência" onClick="copyToClipboard('#copyToClipboardBtn'); return false;"><i class="entypo-clipboard"></i></button>
									</span>
								</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label for="folderName" class="control-label"><?php echo t('edit_folder_sharing_url', 'Copiar URL para a área de transferência:'); ?></label>
								<div class="input-group">
									...
									<span class="input-group-btn" style="vertical-align: top;">
										<button type="button" class="btn btn-primary" onClick="generateFolderSharingUrl(<?php echo (int)$fileFolder->id; ?>); return false;" title="Clique para gerar o URL de compartilhamento..." style="    padding: 7px 12px;"><i class="glyphicon glyphicon-refresh"></i></button>
									</span>
								</div>
				...
				<div role="tabpanel" class="tab-pane" id="viaemail">					
					<div class="row">
						<form action="<?php echo WEB_ROOT; ?>/ajax/_email_folder_url.process.ajax.php" autocomplete="off">
							<div class="col-md-12">
								<div class="form-group" style="margin-bottom: 7px;">
									<label for="shareEmailAddress" class="control-label"><?php echo t('edit_folder_send_via_email', 'Enviar via e-mail:'); ?></label>
									<div class="input-group">
										<input type="text" class="form-control" name="shareEmailAddress" id="shareEmailAddress" placeholder="<?php echo UCWords(t("recipient_email_address", "endereço de email do destinatário")); ?>"/>
										<span class="input-group-btn">
											<button type="button" class="btn btn-info" onClick="processAjaxForm(this, function() { $('#shareEmailAddress').val(''); $('#shareExtraMessage').val(''); }); return false;"><?php echo UCWords(t("send_email", "endereço de email do destinatário")); ?> <i class="entypo-mail"></i></button>
										</span>
									</div>
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
									<textarea id="shareExtraMessage" name="shareExtraMessage" class="form-control" placeholder="<?php echo UCWords(t("extra_message", "mensagem extra (opcional)")); ?>"></textarea>
					...
					<div class="row">
						<div class="col-md-12" style="margin-top: 14px;">
							<p>Você pode mudar se esta pasta é privada ou pública através da opção 'editar pasta'. Observe que, se uma pasta pai estiver configurada como Privada, todas as pastas infantis também serão privadas.</p>
						</div>
					</div>
				</div>
...
<div class="modal-footer">
	<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo t("close", "Fechar"); ?></button>
</div>