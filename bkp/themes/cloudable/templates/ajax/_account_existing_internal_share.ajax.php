...
{
	?>
	<p><?php echo t('edit_folder_internal_share_existing_intro', 'Ações existentes:'); ?></p>
	<table class="table table-striped table-bordered">
		<thead>
			<th><?php echo t('edit_folder_internal_share_email', 'Registered Email Address:'); ?></th>
			<th class="center" style="width: 140px;"><?php echo t('edit_folder_internal_access_level', 'Nível de acesso:'); ?></th>
