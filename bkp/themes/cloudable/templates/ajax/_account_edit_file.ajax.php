...
<form action="<?php echo WEB_ROOT; ?>/ajax/_account_edit_file.process.ajax.php" autocomplete="off">
    <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo t("edit_existing_item", "Editar item existente"); ?> (<?php echo validation::safeOutputToScreen($file->originalFilename, null, 55); ?>)</h4>
    </div>
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label for="folderName" class="control-label"><?php echo t('edit_image_sharing_url', 'Url de compartilhamento:'); ?></label>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label for="folder" class="control-label"><?php echo UCWords(t("file_folder", "pasta de arquivo")); ?></label>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							<label for="reset_stats" class="control-label"><?php echo UCWords(t("reset_stats", "estatísticas de reset")); ?></label>
							<select class="form-control" name="reset_stats" id="reset_stats">
								<option value="0" SELECTED><?php echo t('no_keep_stats', 'Não, mantenha estatísticas'); ?></option>
								<option value="1"><?php echo t('yes_remove_stats', 'Sim, remover estatísticas'); ?></option>
							</select>
						</div>
					</div>
				</div>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-info" onClick="processAjaxForm(this, function() { reloadPreviousAjax(); $('.modal').modal('hide'); }); return false;"><?php echo UCWords(t("update_item", "atualizar item")); ?> <i class="entypo-check"></i></button>
    </div>
</form>