...
$sortingOptions['order_by_filename_asc'] = t('order_by_filename_asc', 'Nome do arquivo ASC');
$sortingOptions['order_by_filename_desc'] = t('order_by_filename_desc', 'Nome do arquivo DESC');
$sortingOptions['order_by_uploaded_date_asc'] = t('order_by_uploaded_date_asc', 'Enviado por Data ASC');
$sortingOptions['order_by_uploaded_date_desc'] = t('order_by_uploaded_date_desc', 'Enviado por Data DESC');
$sortingOptions['order_by_downloads_asc'] = t('order_by_downloads_asc', 'Total de Downloads ASC');
$sortingOptions['order_by_downloads_desc'] = t('order_by_downloads_desc', 'Total de Downloads DESC');
$sortingOptions['order_by_filesize_asc'] = t('order_by_filesize_asc', 'Tamanho do Arquivo ASC');
$sortingOptions['order_by_filesize_desc'] = t('order_by_filesize_desc', 'Tamanho do Arquivo DESC');
$sortingOptions['order_by_last_access_date_asc'] = t('order_by_last_access_date_asc', 'Data do último acesso ASC');
$sortingOptions['order_by_last_access_date_desc'] = t('order_by_last_access_date_desc', 'Data do último acesso DESC');
...
elseif($searchType == 'browserecent')
{
	...
	{
		$pageTitle = t('file_search_results', 'Resultados da pesquisa de arquivos');
	}
	else
	{
		$pageTitle = t('recent_file_uploads', 'Uploads recentes de arquivos');
	}
}
...
elseif($searchType == 'root')
{
	...
	$breadcrumbs[] = '<a href="#" data-toggle="dropdown" class="btn btn-white">Pasta raiz'.$totalText.'&nbsp;&nbsp;<i class="caret"></i></a>'.$dropdownMenu;
...
if($searchType != 'browserecent')
{
	$returnJson['html'] .= '<div class="btn-group">
								...
								<ul role="menu" class="dropdown-menu dropdown-white pull-right">
									<li class="disabled"><a href="#">Ordenar por</a></li>';
