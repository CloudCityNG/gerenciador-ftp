...
<?php endif; ?>
    ...
    {
        if (confirm('<?php echo str_replace('\'', '', t('are_you_sure_you_want_to_empty_the_trash', 'Tem certeza de que deseja esvaziar o lixo? Qualquer estatística e outras informações do arquivo serão excluídas permanentemente.')); ?>'))
        {
            emptyTrash();
        }
    ...
    function showFileMenu(liEle, clickEvent)
    {
        ...
        if (isDeleted == false)
        {
            ...
            items["Edit"] = {
                "label": "<?php echo UCWords(t('account_file_details_edit_file_info', 'Editar informações do arquivo')); ?>",
				"icon": "glyphicon glyphicon-pencil",
                "action": function (obj) {
			...
			items["Duplicate"] = {
                "label": "<?php echo UCWords(t('account_file_details_create_copy', 'Criar cópia')); ?>",
